...
import { ASPECT_ICON, ASPECT_LABEL, num, severityLabel } from "@/lib/format";
import type { AspectKey } from "@/lib/types";

export const metadata: Metadata = {
  title: "Metode & Keterbatasan — MARTAHUTA",
  description:
...
FrictionIndex = Σ  mention_rate × neg_rate × |severity|   (ditampilkan × 100)`}
      ...
      <Card className="p-4 sm:p-5">
        ...
        <ul className="space-y-2.5 text-[13px] leading-relaxed text-ink-2">
          <li>
            ⚠ <strong>Skor friksi berasal dari baseline keyword + rating, BUKAN
            model IndoBERT terlatih.</strong>{" "}
            Lapisan itu diganti setelah model tahap preliminary selesai, dan
            macro-F1-nya dilaporkan.
          </li>
          <li>
            ✓ <strong>Nama tempat, koordinat, dan seluruh kutipan ulasan adalah
            data asli</strong>{" "}
            dataset panitia. Tidak ada kutipan karangan.
          </li>
          <li>
            ○ {num(noReview)} tempat tidak punya ulasan sama sekali. Mereka{" "}
            <strong>ditampilkan</strong> sebagai prioritas survei lapangan,
            bukan disembunyikan.
          </li>
          <li>
            ○ {num(lowConf)} tempat dengan &lt; 20 ulasan berteks ditandai
          ...
          <li>
            ⚠ Korelasi gap infrastruktur ↔ tingkat keluhan <strong>bukan</strong>{" "}
          ...
          <li>
            ⚠ Bias platform: seluruh ulasan berasal dari pengguna Google Maps —
