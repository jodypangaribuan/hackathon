...
export const metadata: Metadata = {
  ...
  description: "Demo leksikal terpisah dari model intelligence utama.",
};
    ...
    <div className="space-y-4">
      <section>
        ...
        <p className="mt-1 max-w-3xl text-[13px] leading-relaxed text-ink-2">
          Model intelligence utama berjalan sebagai batch inference, bukan
          endpoint model real-time.
