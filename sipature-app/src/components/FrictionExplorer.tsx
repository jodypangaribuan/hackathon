  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_360px]">
                ...
                {selected.topAspects.length > 0 ? (
                  <p className="mt-2 text-[12px] text-ink-2">
                    ...
                    {selected.topAspects.slice(0, 3).map((a, i) => (
                      <span key={a}>
                        {i > 0 ? " · " : ""}
                         <span className="inline-flex items-center gap-1"><AspectIcon aspect={a} />{ASPECT_LABEL[a]}</span>
                      </span>
                    ))}
                  </p>
                ) : null}
      ...
      <div className="min-w-0">
        ...
        <div className="mt-3">
          <Note>
             Tempat dengan &lt; 20 ulasan berteks ditandai kepercayaan rendah dan
             dikeluarkan dari peringkat — sampel
