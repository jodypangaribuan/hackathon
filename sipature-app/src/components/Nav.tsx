...
import { Activity, BarChart3, BrainCircuit, FlaskConical, ListChecks, Moon, Sun } from "lucide-react";
    ...
    >
      <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-6 px-4">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-[15px] font-semibold tracking-tight">SIPATURE</span>
        ...
        <nav className="flex items-center gap-1 text-[13px]">
          {LINKS.map((l) => {
            ...
            return (
              ...
              >
                <span className="inline-flex items-center gap-1.5"><l.icon size={13} />{l.label}</span>
              </Link>
            );
          })}
        </nav>
